...
class bar:
    #maximum value, minimum value, px between whole-number locations on bar, height in pixels of bar window, background color, bar color
    def __init__(self, maximum=100, minimum=0, ticklen=2, height=100, bgcolor=[0,0,0], bcolor=[0,255,0], wx=None, wy=None): 
