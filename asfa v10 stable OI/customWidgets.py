...
from PyQt5.QtWidgets import (
    ...
    QTabWidget, QAction, QCompleter, QComboBox,
)
...
class Completer(QCompleter):
    ...
    def updateModel(self):
        ...
        pattern = QRegExp(self.local_prefix, Qt.CaseInsensitive, QRegExp.FixedString)
...
class DNEdit(QComboBox):
    ...
    def validate(self, text):
        if not text:
            self.error_action.setToolTip("This field is required")
            self.line_edit.addAction(self.error_action, QLineEdit.LeadingPosition)
