...
from PyQt5.QtCore import Qt, QSize, QRect, QPoint, QThreadPool, QItemSelection, pyqtSlot
...
class DiskMan():
    ...
    def create_files_list(self, items: tuple, folder: str):
        ...
        # self.table.horizontalHeader().setSizeAdjustPolicy(QHeaderView.AdjustToContents)
        ...
        self.folders_tab.addTab(
            self.table, trim_text(folder_name, 15) if folder_name else folder)
