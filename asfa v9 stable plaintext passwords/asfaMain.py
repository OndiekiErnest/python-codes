...
from customWidgets import (
    ...
    PasswordEdit, QHBoxLayout, QSize, SearchInput,
)
import asfaUtils
...
class ShareManager(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.online_users_dropdown.setToolTip("Click and select a username\nGo to Settings to set a username")
        self.on_banner = 0
...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.setStyleSheet("background: #f7fffe")
...
class Controller(MainWindow):
    ...
    def __init__(self):
        ...
        # Folder tansfer win
        self.folder_transfers_win = FolderTransferWin(self.saved_settings)
    ...
    def register_worker(self, src, dst, task):
        ...
        if self.worker_manager.is_valid(transfer_worker):
            ...
            self.center_statusbar_signal.emit(f"Skipped: '{common._basename(src)}' is already in transfer queue")
