"""custom pyqt6 circular progress bar"""
...
class RoundProgressbar(QWidget):
    ...
    def __init__(
        ...
        if parent is not None:
            ...
            super().__init__()
        self.setObjectName("roundedprogress")
    ...
    def paintEvent(self, paint_event):
        ...
        painter.setPen(QPen(self._bg_circle_color, self._thickness - 1, Qt.PenStyle.SolidLine))
        if self._fill_bg_circle:
            painter.setBrush(QBrush(self._bg_circle_color, Qt.BrushStyle.SolidPattern))
        ...
        if self._round_edge:
            painter.setPen(QPen(self._color, self._thickness, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap))
        elif not self._round_edge:
            painter.setPen(QPen(self._color, self._thickness, Qt.PenStyle.SolidLine, Qt.PenStyle.FlatCap))
        painter.setBrush(Qt.BrushStyle.NoBrush)
        painter.drawArc(
            self._thickness,
            self._thickness,
